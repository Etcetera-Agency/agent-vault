...
Services may carry quota and account-pool policy. These fields are optional and
round-trip through the management API; services that omit them behave as
unlimited until quota enforcement is enabled.
