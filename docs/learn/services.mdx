...
Service list and discovery responses render unrestricted methods as `methods: ["*"]` so operators and agents can audit the policy without inferring from an omitted field.
